...
namespace VPFrameworks.Messaging.Azure.PushNotifications
{
    ...
    /// 
    /// </summary>
    public class ApplePushNotifications : NotificationService 
    {
        ...
        public ApplePushNotifications(string messageTemplate, ITextSerializer textSerializer, ConnectionSettings settings) : base(messageTemplate, textSerializer, settings)
        {
        ...
        {
            var result = await this.hubClient.SendAppleNativeNotificationAsync(payload, token);
            return result;
        }
        ...
        {
            var result = await this.hubClient.SendAppleNativeNotificationAsync(payload, tag, token);
            return result;
        }
